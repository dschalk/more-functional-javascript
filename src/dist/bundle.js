	...
	function main(sources) {
	  ...
	  var messages$ = sources.WS.map(function (e) {
	    ...
	    e.data.split(',').map(function (v) {
	      ...
	      mMZ13.bnd(function () {
	        retrn(mMgoals2, 'A player named ' + v[2] + ' is currently logged in. Page will refresh in 4 seconds.');
	        refresh();
	      });
	    ...
	    bind(ret(e.data.split(',')[0]), next, 'CA#$42', mMZ10)(temp, next, 'CD#$42', mMZ11)(temp, next, 'CE#$42', mMZ12)(temp, next, 'EE#$42', mMZ13)(temp, next, 'DD#$42', mMZ14)(temp, next, 'NN#$42', mMZ15)(temp, next, 'ZZ#$42', mMZ16)(temp, next, 'RR#$42', mMZ17)(temp, next, 'WW#$42', mMZ18)(temp, next, 'ZN#$42', mMZ19)(temp, next, 'ZE#$42', mMZ20)(temp, next, 'ZD#$42', mMZ21);
	  });
